                  ...
                  <div class="row">
                    ...
                    <div class="col-6">
                      <div class="row">
                        <div class="col-12">
                          <div class="w-100">
                          <a class="nav-link main" href="filter.php">View all Brans and Designers</a>
                          </div>
            ...
            <div class="list">
                <div class="list-container">
                  <div class="row">
                    ...
                    <div class="col-12">
                          <div class="w-100">
                            <a class="nav-link" href="launches.php">VIEW UPCOMING RELEASES</a>
                          </div>
                            ...
                            <div class="col-4 mb-3">
                              <div class="row">
                                ...
                                <div class="col-7">
                                    ...
                                    <div class="launches-description">
                                      <span>lorem ipsum donor</span>
                                    </div>
                                    <div class="launches-date">
                                      <span>22/06/2018 @ 00:01 GTM</span>
                                    </div>
                                </div>
                              </div>
                            </div>
                  ...
                  <div class="row">
                    <div class="col-6">
                      <div class="row">
                        <div class="col-12">
                          <div class="w-100">
                            <a class="main" href="">ALL CATEGORIES</a>
                          </div>
                          <div class="column-box">
                            <div class="columns">
                              <ul class="nav-ul-list">
  ...
  <div class="row w-100 h-100 mx-0">
    ...
    <div class="col-lg-5 col-md-5 col-4 px-0-nav">
      <button class="btn btn-secondary cart-btn sidebarCollapse pull-right" type="button">
         <span><i class="fa fa-shopping-cart" aria-hidden="true"></i> </span><span class="d-xl-block d-lg-none d-md-none d-none">(0)</span></a>
      </button>
